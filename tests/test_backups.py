...
from .testing_utility_functions import BACKUP_DEST_DIR, FAKE_HOME_DIR, DOTFILES, setup_dirs_and_env_vars_and_create_config, clean_up_dirs_and_env_vars
...
class TestBackupMethods:
	...
	def test_conditions(self):
		...
		for dot, _ in config["dotfiles"].items():
			config["dotfiles"][dot]["backup_condition"] = "[[ $(uname -s) == 'Made Up OS' ]]"
		write_config(config)
