...
def setup_env_vars():
	os.environ["SHALLOW_BACKUP_TEST_BACKUP_DIR"] = os.path.abspath(BASE_TEST_DIR) + "/backup"
	os.environ["SHALLOW_BACKUP_TEST_HOME_DIR"] = os.path.abspath(BASE_TEST_DIR) + "/home"
	# This env var is referenced in shallow_backup/config.py
	os.environ["SHALLOW_BACKUP_TEST_CONFIG_PATH"] = os.path.abspath(BASE_TEST_DIR) + "/shallow-backup.conf"
