...
def backup_packages(backup_path):
	...
	for mgr in std_backup_package_managers:
		...
		print(Fore.BLUE + "Backing up" + Fore.GREEN + "{}" + Fore.BLUE + " package list...".format(mgr) + Style.RESET_ALL)
		command = "{0} list > {1}/{2}_list.txt".format(mgr,
		                                               backup_path, mgr.replace(" ", "-"), True)
		sp.run(command, shell=True, stdout=sp.PIPE)

	# cargo
	print(Fore.BLUE + "Backing up" + Fore.GREEN + "cargo" + Fore.BLUE + " package list..." + Style.RESET_ALL)
	sp.run("ls {0}/.cargo/bin/ > {1}/cargo_list.txt".format(os.path.expanduser('~'),
	                                                        backup_path), shell=True, stdout=sp.PIPE)

	# pip
	print(Fore.BLUE + "Backing up " + Fore.GREEN + "pip" + Fore.BLUE + "package list..." + Style.RESET_ALL)
	sp.run("pip list --format=freeze > {}/pip_list.txt".format(backup_path), shell=True, stdout=sp.PIPE)

	# npm
	print(Fore.BLUE + "Backing up " + Fore.GREEN + "npm" + Fore.BLUE + "package list..." + Style.RESET_ALL)
	...
	print(Fore.BLUE + "Backing up " + Fore.GREEN + "Atom" + Fore.BLUE + "package list..." + Style.RESET_ALL)
	sp.run("apm list --installed --bare > {}/apm_list.txt".format(backup_path), shell=True, stdout=sp.PIPE)

	# sublime text packages
	if os.path.isdir(_home_prefix("Library/Application Support/Sublime Text 2")):
		print(Fore.BLUE + "Backing up " + Fore.GREEN + "Sublime" + Fore.BLUE + "Text package list..." + Style.RESET_ALL)
	...
	# macports
	print(Fore.BLUE + "Backing up " + Fore.GREEN + "macports" + Fore.BLUE + "package list..." + Style.RESET_ALL)
	sp.run("port installed requested > {}/macports_list.txt".format(backup_path),
	       shell=True, stdout=sp.PIPE)

	# system installs
	print(Fore.BLUE + "Backing up " + Fore.GREEN + "system" + Fore.BLUE + "application list..." + Style.RESET_ALL)
